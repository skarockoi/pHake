...
3. Extract the <a href="https://github.com/xhz8s/pHake/releases/download/0/dp.zip">Dependencies</a> in the Executable folder <br/><br/>
You can use the latest <a href="https://github.com/xhz8s/pHake/releases/download/4.0/pHake4.0_1.5.zip">Release</a> as an example
