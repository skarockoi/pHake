...
# Download
<a href="https://github.com/xhz8s/pHake/releases/download/4.1/pHake.4.1_1.5.zip">Latest Version (Steam)</a><br/>
...
3. Extract the <a href="https://github.com/xhz8s/pHake/releases/download/0/dp.zip">Dependencies</a> in the Executable folder <br/>
- You can use the latest <a href="https://github.com/xhz8s/pHake/releases/download/4.1/pHake.4.1_1.5.zip">Release</a> as an example
